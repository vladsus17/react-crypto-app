...
var DisabledContext = React4.createContext(false);
var DisabledContextProvider = (_ref) => {
  let {
    children,
    disabled
  } = _ref;
  const originDisabled = React4.useContext(DisabledContext);
  return React4.createElement(DisabledContext.Provider, {
...
var SizeContext = React5.createContext(void 0);
var SizeContextProvider = (_ref) => {
  let {
    children,
    size
  } = _ref;
  const originSize = React5.useContext(SizeContext);
  return React5.createElement(SizeContext.Provider, {
...
var fullClone = Object.assign({}, React6);
var {
  useId
} = fullClone;
var useEmptyId = () => "";
...
function useSyncState(defaultValue) {
  var _React$useReducer = React10.useReducer(function(x) {
    return x + 1;
  }, 0), _React$useReducer2 = _slicedToArray(_React$useReducer, 2), forceUpdate = _React$useReducer2[1];
  var currentValueRef = React10.useRef(defaultValue);
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        return React16.createElement(Component3, restProps, keyEntities.map(function(_ref2, index) {
...
function MotionWrapper(props) {
  ...
  const needWrapMotionProviderRef = React17.useRef(false);
  needWrapMotionProviderRef.current = needWrapMotionProviderRef.current || motion === false;
  if (needWrapMotionProviderRef.current) {
    return React17.createElement(MotionProvider, {
      motion
    }, children);
  }
  return children;
...
var PropWarning = React18.memo((_ref) => {
  let {
...
var ProviderChildren = (props) => {
  ...
  const getPrefixCls = React19.useCallback((suffixCls, customizePrefixCls) => {
    const {
      prefixCls
    } = props;
    if (customizePrefixCls) {
  ...
  const {
    layer
  } = React19.useContext(StyleContext_default);
  const memoIconContextValue = React19.useMemo(() => ({
    prefixCls: iconPrefixCls,
    csp,
    layer: layer ? "antd" : void 0
  }), [iconPrefixCls, csp, layer]);
  let childNode = React19.createElement(React19.Fragment, null, React19.createElement(PropWarning_default, {
    dropdownMatchSelectWidth
  }), children);
  const validateMessages = React19.useMemo(() => {
    var _a, _b, _c, _d;
  ...
  if (Object.keys(validateMessages).length > 0) {
    childNode = React19.createElement(validateMessagesContext_default.Provider, {
      value: validateMessages
    }, childNode);
  }
  if (locale5) {
    childNode = React19.createElement(locale_default, {
      locale: locale5,
      _ANT_MARK__: ANT_MARK
    }, childNode);
  }
  if (iconPrefixCls || csp) {
    childNode = React19.createElement(Context_default.Provider, {
      value: memoIconContextValue
    }, childNode);
  }
  if (componentSize) {
    childNode = React19.createElement(SizeContextProvider, {
      size: componentSize
    }, childNode);
  }
  childNode = React19.createElement(MotionWrapper, null, childNode);
  ...
  if (theme) {
    childNode = React19.createElement(DesignTokenContext.Provider, {
      value: memoTheme
    }, childNode);
  }
  if (memoedConfig.warning) {
    childNode = React19.createElement(WarningContext.Provider, {
      value: memoedConfig.warning
    }, childNode);
  }
  if (componentDisabled !== void 0) {
    childNode = React19.createElement(DisabledContextProvider, {
      disabled: componentDisabled
    }, childNode);
  }
  return React19.createElement(ConfigContext.Provider, {
    value: memoedConfig
  }, childNode);
};
var ConfigProvider = (props) => {
  const context = React19.useContext(ConfigContext);
  const antLocale = React19.useContext(context_default);
  return React19.createElement(ProviderChildren, Object.assign({
...
var LayoutContext = React20.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
var SiderContext = React22.createContext({});
...
var Sider = React22.forwardRef((props, ref) => {
  const {
    ...
    onCollapse,
    onBreakpoint
  } = props, otherProps = __rest2(props, ["prefixCls", "className", "trigger", "children", "defaultCollapsed", "theme", "style", "collapsible", "reverseArrow", "width", "collapsedWidth", "zeroWidthTriggerStyle", "breakpoint", "onCollapse", "onBreakpoint"]);
  const {
    siderHook
  } = (0, import_react10.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react10.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react10.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react10.useRef)(null);
  ...
  const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React22.createElement("span", {
    onClick: toggle,
  ...
  }, trigger || React22.createElement(BarsOutlined_default, null)) : null;
  const reverseIcon = direction === "rtl" === !reverseArrow;
  const iconObj = {
    expanded: reverseIcon ? React22.createElement(RightOutlined_default, null) : React22.createElement(LeftOutlined_default, null),
    collapsed: reverseIcon ? React22.createElement(LeftOutlined_default, null) : React22.createElement(RightOutlined_default, null)
  };
  const status = collapsed ? "collapsed" : "expanded";
  const defaultTrigger = iconObj[status];
  const triggerDom = trigger !== null ? zeroWidthTrigger || React22.createElement("div", {
  ...
  return wrapCSSVar(React22.createElement(SiderContext.Provider, {
    value: contextValue
  }, React22.createElement("aside", Object.assign({
    className: siderCls
  }, divProps, {
    style: divStyle,
    ref
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React23.forwardRef((props, ref) => React23.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React23.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
    tagName: TagName
  } = props, others = __rest3(props, ["prefixCls", "suffixCls", "className", "tagName"]);
  const {
    getPrefixCls
  ...
  return wrapSSR(React23.createElement(TagName, Object.assign({
    className: (0, import_classnames3.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId, cssVarCls),
    ref
  }, others)));
});
var BasicLayout = React23.forwardRef((props, ref) => {
  const {
    direction
  } = React23.useContext(ConfigContext);
  const [siders, setSiders] = React23.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
    ...
    tagName: Tag,
    style: style2
  } = props, others = __rest3(props, ["prefixCls", "className", "rootClassName", "children", "hasSider", "tagName", "style"]);
  ...
  return wrapCSSVar(React23.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React23.createElement(Tag, Object.assign({
    ref,
...
//# sourceMappingURL=chunk-7WTJZJC3.js.map
